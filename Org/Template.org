...
#+author:AUTHOR
#+date:2022-01-20 08:57
#+macro:version Version 0.7.1
...
**** TODO Restore Boot upon running update-org-sync
- State "TODO"       from              [2022-01-20 Thu 08:56] \\
  When running ~update-org-template~, make sure the Boot Makefile is
  tangled.
...
* Build Scripts
  ...
  :dependency1: $DEV/bin exists and is in $PATH
  :END:
...
**** Create New Project Code
 ...
 #+begin_src emacs-lisp
   ...
   - Upload the git repo into GitHub, add a description to the GitHub repo."
     ...
     (setq resources-subdirs (list "tools/" "images/" "source/"))
