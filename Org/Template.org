...
#+author:AUTHOR
#+date:2020-10-23 08:17
#+macro:version Version 0.6.32
...
*** Create New Project
 ...
 #+header: :tangle /Users/minilolh/Dev/bin/org-template.el
 #+begin_src emacs-lisp
   (defun create-new-project (project title author &optional bucket)
     "Create a new project in a new directory.

   This includes creating the 'resources' directory and the list of
   subdirectories to go inside the resources directory."
     (message "NEW PROJECT=%s TITLE=%s AUTHOR=%s BUCKET=%s" project title author bucket)
     (mkdir project t)
     (mkir (concat project "/" "resources"))
     (let ((rsrcdir "resources")
	   (subdirs (list "tools" "images")))
       (dolist (subdir subdirs)
	 (mkdir (concat project "/" rsrcdir "/" subdir))))
...
#+header: :tangle /Users/minilolh/Dev/bin/replace-build-tools
#+header: :shebang "#! /Applications/MacPorts/Emacs.app/Contents/MacOS/Emacs --script"
#+begin_src elisp
(load-file "/Users/minilolh/Dev/bin/org-template.el")
...
**** Run Create
 ...
 #+header: :tangle /Users/minilolh/Dev/bin/new-org-template
...
template file.
 ...
 #+header: :tangle /Users/minilolh/Dev/bin/update-org-template
 #+header: :shebang "#!/Applications/MacPorts/Emacs.app/Contents/MacOS/Emacs --script"
 #+begin_src emacs-lisp
   (require 'org)
...
*** Create and Update Script                                   :dependencies:
 ...
 #+header: :mkdirp yes
 ##+header: :tangle /Users/minilolh/Dev/bin/org-template
 #+header: :shebang "#!/usr/bin/env bash"
 #+begin_src sh -n
...
#+header: :mkdirp yes
#+header: :shebang "#!/usr/bin/env bash"
#+header: :tangle /Users/minilolh/Dev/bin/switch-emacs-init
#+begin_src sh
  printf "${GREEN}"
...
#+name:syncrc
#+header: :mkdirp yes
#+header: :tangle /Users/minilolh/Dev/bin/syncrc
#+header: :shebang "#!/usr/bin/env bash"
#+begin_src shell
  [ -v TEMPLATES ] || {
