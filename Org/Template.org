...
#+begin_src makefile
  ...
  # This name used to be statically embedded into the Makefile during
  # tangle, but in an effort to make the Makefile dynamically
  ...
  # into a 'perl' object which can return the login name.  This code
  # should work with any version of 'perl' without having to install any
  # modules.
